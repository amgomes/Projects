...
public class WeatherMapTest extends TestCase
{
    ...
    public void testTransformCityAndHandleExceptionsFromServiceCatchRuntimeException() throws IOException, JSONException{
        ...
        System.out.println(errorData.getExceptionMessage());
        System.out.println(serviceFailMessage);
        assertTrue(errorData.hasException());
    }

    public void testGetExceptionMessageForCityWithExceptionMessage() throws IOException, JSONException {
        WeatherService weatherServiceWithError = Mockito.mock(WeatherService.class);
        when(weatherServiceWithError.getWeatherForCity(errorCity1.getCity()))
                .thenThrow(new RuntimeException(serviceFailMessage));
        ...
        assertTrue(errorData.getExceptionMessage().compareTo("Optional[java.lang.RuntimeException: " + serviceFailMessage + "]") == 0);
    }

    public void testGetExceptionMessageForCityReturnsEmptyStringIfThereIsNoException() {
        assertTrue(houston.getExceptionMessage() == "");
    }
