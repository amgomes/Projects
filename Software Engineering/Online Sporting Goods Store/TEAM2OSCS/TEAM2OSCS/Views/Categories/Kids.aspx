<%-- 
Name: Kids.aspx
Description: This view displays all of the items for category = 1 ("Women's Clothing).
...
<asp:Content ID="kidsTitle" ContentPlaceHolderID="TitleContent" runat="server">
    Kids
</asp:Content>

<asp:Content ID="kidsContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Kids</h2>

     <div class="categoryImage">
            <img class="Img2" src="~/Images/surfshorts.jpg" alt="Boy's SurfShorts" runat="server" height="220" width="220"/>
            <p id="center">Boy's SurfShorts</p>
     </div>
     <br />
     <br />
     <br />
