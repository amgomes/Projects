...
<asp:Content ID="womenTitle" ContentPlaceHolderID="TitleContent" runat="server">
    Women
</asp:Content>

<asp:Content ID="WomenContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Women</h2>

        <div class="categoryImage">
            <img id="Img1" src="~/Images/shorts.jpg" alt="Women's Shorts" runat="server" height="220" width="220"/>
            <p id="center">Women's Shorts</p>
        </div>
     <br />
     <br />
     <br />
