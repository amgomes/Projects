<%-- 
Name: SportingGoods.aspx
Description: This view displays all of the items for category = 4 ("Outdoor Gear").
...
<asp:Content ID="sportingGoodsTitle" ContentPlaceHolderID="TitleContent" runat="server">
    Sporting Goods
</asp:Content>

<asp:Content ID="sportingGoodsContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Sporting Goods</h2>

     <div class="categoryImage">
            <img id="Img1" src="~/Images/tent.jpg" alt="3-Season Tent" runat="server" height="220" width="220"/>
            <p id="center">3-Season Tent</p>
     </div>
     <br />
     <br />
     <br />
